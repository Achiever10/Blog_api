...
schema_view = get_schema_view(
    openapi.Info(
        ...
        contact=openapi.Contact(email="Abisagboolabeloved@gmail.com"),  # Contact email for the API
...
urlpatterns = [
    ...
    # API Endpoints
    path("api/users/", include("user.urls")),  # Include URLs from the 'users' app
    # path("api/blog/", include("post.urls")),  # Include URLs from the 'blog' app
